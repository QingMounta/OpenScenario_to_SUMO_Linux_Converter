...
if __name__ == '__main__':
    ...
    trajectories = pd.read_csv("C:/Users/Napoleon the Beast/Documents/TianZheng/Esmini/esmini-2.31.9/esmini-2.31.9/full_log.csv",sep=",",header=6)
    # print(trajectories)
    print(trajectories)
    print(trajectories.loc[0][' #1 World_Position_X [m] '])
    print(trajectories.loc[0][' #1 World_Pitch_Angle [rad] ']/3.14*180)
    print(trajectories.loc[:][' #1 World_Heading_Angle [rad] ']/3.14*180)
    # trajectories[:][' #1 World_Heading_Angle [rad] '].to_csv('C:/Users/Napoleon the Beast/Documents/TianZheng/Esmini/esmini-2.31.9/esmini-2.31.9/full_log_clear.csv')
    # print(route_list)
    ...
    while True:
        ...
        traci.vehicle.moveToXY("Ego_vehicle","", 1 ,trajectories.loc[step][' #1 World_Position_X [m] ']+offset_x,trajectories.loc[step][' #1 World_Position_Y [m] ']+offset_y,-1073741824.0,2)
        step += 1
